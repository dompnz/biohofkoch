		...
		<Layout showNav={false} showFooter={false}>
			...
			<div className="min-h-screen flex flex-col lg:flex-row">
				...
				<div className="flex relative h-[40vh] lg:h-auto lg:w-2/3">
					...
					/>
					{/* desktop logo */}
					<img src="/assets/images/logo-with-border.svg" alt="Biohof Koch Logo" className="hidden lg:block absolute left-full top-1/3 transform -translate-x-1/2 -translate-y-1/2 w-1/2 w-[345px]" />
				</div>
				...
				<div className="container max-w-none flex-grow mt-8 pb-12 lg:mt-0 lg:p-12 xl:p-20 flex flex-col lg:w-1/3">
					...
					<a href={attributes.facebooklink} target="_blank" rel="noreferrer" className="flex items-center flex-wrap animated-underlines">
						<img src="/assets/images/facebook.svg" alt="facebook icon" width="22px" height="22px" className="inline mr-4 object-contain object-center" />
